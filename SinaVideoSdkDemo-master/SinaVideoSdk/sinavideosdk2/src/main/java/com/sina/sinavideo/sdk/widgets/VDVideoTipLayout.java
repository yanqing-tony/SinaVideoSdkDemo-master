 ...
 * 
 */
public final class VDVideoTipLayout extends RelativeLayout implements
		VDBaseWidget, OnVideoOpenedListener, OnTipListener {
	...
	private void init(Context context) {
		View v = LayoutInflater.from(context)
				.inflate(R.layout.tip_layout, null);
		addView(v);
	...
	public void registerListener() {
		...
		if (controller != null)
			controller.addOnTipListener(this);
	...
	private OnClickListener mCloseListener = new OnClickListener() {
		...
		public void onClick(View v) {
			setVisibility(GONE);
			VDVideoViewController controller = VDVideoViewController
					.getInstance(VDVideoTipLayout.this.getContext());
			if (controller != null)
				controller.notifyHideTip();
		}
	};
