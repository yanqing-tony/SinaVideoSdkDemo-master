 ...
 * 
 */
public final class VDVideoErrorLayout extends RelativeLayout implements
		VDBaseWidget, OnVideoOpenedListener, OnErrorListener,
	...
	private void init(Context context) {
		View v = LayoutInflater.from(context).inflate(
				R.layout.video_play_error_layout, null);
	...
	public void registerListener() {
		...
		if (controller != null)
			controller.addOnRetryErrorListener(this);
		mBtnReplay.setOnClickListener(mRetryListener);
		if (controller != null)
			controller.addOnClickRetryListener(this);
	}
	...
	private OnClickListener mRetryListener = new OnClickListener() {
		...
		public void onClick(View v) {
			VDVideoViewController controller = VDVideoViewController
					.getInstance(VDVideoErrorLayout.this.getContext());
			if (controller == null)
				return;
